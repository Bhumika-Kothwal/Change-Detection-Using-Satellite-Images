    ...
    for i in range(x[0]):
      for j in range(x[1]):
        if edge1[i][j] != 0:
          imcopy[i][j] = (0, 0, 255)
          if i-1 >= 0 and j-1 >= 0:
            imcopy[i-1][j-1] = (0, 0, 255)
          if i-1 >= 0:
            imcopy[i-1][j] = (0, 0, 255)
          if i-1 >= 0 and j+1 < x[1]:
            imcopy[i-1][j+1] = (0, 0, 255)
          if j+1 < x[1]:
            imcopy[i][j+1] = (0, 0, 255)
          if j-1 >= 0:
            imcopy[i][j-1] = (0, 0, 255)
          if i+1 < x[0] and j-1 >= 0:
            imcopy[i+1][j-1] = (0, 0, 255)
          if i+1 < x[0]:
            imcopy[i+1][j] = (0, 0, 255)
          if i+1 < x[0] and j+1 < x[1]:
            imcopy[i+1][j+1] = (0, 0, 255)
    cv2.imwrite(out_dir+'Final.jpg', imcopy)
